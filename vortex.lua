...
if not isfile("VORTEX_DONT_DELETE") then
    makefolder("VORTEX_DONT_DELETE")
end
...
local Tween = loadstring(game:HttpGet("https://raw.githubusercontent.com/BassDarius/libs/main/tween.lua"))()
local notifications1 = {}
local notifications2 = {}
menu.bg.Position     = UDim2.new(0.5,-menu.bg.Size.X.Offset/2,0.5,-menu.bg.Size.Y.Offset/2)
menu.Parent          = game:GetService("CoreGui")
menu.bg.pre.Text = 'Vortex<font color="#ac51e0">.hook</font><font color="#ffffff"> | </font><font color="#ac51e0">Paid</font><font color="#ffffff"> | </font><font color="#ac51e0">Game: </font><font color="#ffffff">Trident Survival V2</font>'
...
function library:createConfig()
    ...
    writefile("Sython_V2/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
...
function library:refreshConfigs()
    local tbl = {}
    for i,v in next, listfiles("Sython_V2") do
        table.insert(tbl,v)
    end
